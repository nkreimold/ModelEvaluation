#' Reporting the information of Data Quality for table of the DBMS
#'
...
#' @export
#' 
Qual_report.tbl_dbi <- function(.data, 
                                DataDict=NULL,
                                DateName=NULL,
                                datetofilteron=NULL, 
                                saveoutputs=NULL,
                                output_format = "html",
                                output_file = NULL, output_dir = tempdir(),in_database = FALSE, 
                               collect_size = Inf, ...) {
...
#  output_format <- match.arg(output_format)
  ...
  if (in_database) {
    ...
    Qual_report(tab, target = vars, output_format, 
